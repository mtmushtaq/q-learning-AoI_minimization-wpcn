...
store_dirs_rd = ["Random_S_200_U_100"]
...
compare_battery_per_user_fixed_methods(BT_dict, "BatteryPlots", "BT_Users005", gain_value=0.5)
compare_battery_mean_overall_fixed_methods(BT_dict, "BatteryPlots", "BT_Mean005", gain_value=0.5)
