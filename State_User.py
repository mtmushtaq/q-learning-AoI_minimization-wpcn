...
def gamma_EH(channel, dist_l, dist_h):  # we utilize different distance for desired user and interference user since intereference will be coming from more than 30 meter from another cluster
