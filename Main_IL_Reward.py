...
K_factor =  12
decay_rate = 0.0005
upsilon = 0.0020 # One unit to transmit one replica
d_slot = 1
chg_slots = 80
...
for i in range(number_of_users):  # popola il vettore degli utenti
    # users[i] = i + 1
    users.append(User(id=i, mu=upsilon, initial_battery_level=0.005))  # inizializza ogni utente con un livello di batteria di 0.005
